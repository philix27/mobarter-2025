...
///
- (void)addCustomTokensWithAddress:(NSString * _Nonnull)address tokenAddresses:(NSArray<NSString *> * _Nonnull)tokenAddresses successHandler:(void (^ _Nonnull)(NSArray<TokenModel *> * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler SWIFT_DEPRECATED_MSG("Use ParticleWalletGUI.setCustomTokenAddresses() instead.");
...
/// \param failureHandler Failure Handler
///
- (void)createTransactionFrom:(NSString * _Nonnull)from to:(NSString * _Nullable)to value:(NSString * _Nullable)value contractParams:(ContractParams * _Nullable)contractParams gasFeeLevel:(enum GasFeeLevel)gasFeeLevel action:(enum Action)action successHandler:(void (^ _Nonnull)(NSString * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
/// Create a transaciton
/// \param from From address
///
/// \param to If you send a erc20, erc721, erc1155 or interact with a contract, this is the contract address, if you send native, this is receiver address.
...
/// \param failureHandler Failure Handler
///
- (void)createTransactionFrom:(NSString * _Nonnull)from to:(NSString * _Nullable)to value:(NSString * _Nullable)value data:(NSString * _Nonnull)data gasFeeLevel:(enum GasFeeLevel)gasFeeLevel action:(enum Action)action successHandler:(void (^ _Nonnull)(NSString * _Nonnull))successHandler failureHandler:(void (^ _Nonnull)(NSError * _Nonnull))failureHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// returns:
/// Solana service
+ (SolanaChain * _Nonnull)solana SWIFT_WARN_UNUSED_RESULT;
/// Get evm service
///
/// returns:
/// EVM service
+ (EVMChain * _Nonnull)evm SWIFT_WARN_UNUSED_RESULT;
/// Get solana service
///
/// returns:
/// Solana service
