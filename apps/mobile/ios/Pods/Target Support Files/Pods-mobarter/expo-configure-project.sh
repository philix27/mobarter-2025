...
with_node \
  ...
  --target "/Volumes/philix-sata-ssd/Mobarter/mobart/apps/mobile/ios/Pods/Target Support Files/Pods-mobarter/ExpoModulesProvider.swift" \
  --entitlement "/Volumes/philix-sata-ssd/Mobarter/mobart/apps/mobile/ios/mobarter/mobarter.entitlements" \
  --platform "apple" \
  --packages "@privy-io/expo-native-extensions" "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-clipboard" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser" "react-native-passkeys"
