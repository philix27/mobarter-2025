 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Adverts_update($input: Advert_UpdateInput!) {\n  adverts_update(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nmutation Adverts_create($input: Advert_CreateInput!) {\n  adverts_create(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nmutation Adverts_delete($input: Advert_DeleteInput!) {\n  adverts_delete(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nquery Adverts_getAll($input: Advert_GetAllInput!) {\n  adverts_getAll(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nquery Adverts_getOne($input: Advert_GetOneInput!) {\n  adverts_getOne(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}"): (typeof documents)["mutation Adverts_update($input: Advert_UpdateInput!) {\n  adverts_update(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nmutation Adverts_create($input: Advert_CreateInput!) {\n  adverts_create(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nmutation Adverts_delete($input: Advert_DeleteInput!) {\n  adverts_delete(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nquery Adverts_getAll($input: Advert_GetAllInput!) {\n  adverts_getAll(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}\n\nquery Adverts_getOne($input: Advert_GetOneInput!) {\n  adverts_getOne(input: $input) {\n    rate\n    state\n    currency\n    lowerLimit\n    rate\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Auth_login($input: Auth_LoginInput!) {\n  auth_login(input: $input) {\n    firstname\n    country\n    lastname\n    middlename\n    email\n    token\n  }\n}\n\nmutation Auth_resetPassword($input: Auth_ResetPasswordInput!) {\n  auth_resetPassword(input: $input) {\n    message\n  }\n}\n\nmutation Auth_sendEmailOtp($input: Auth_sendEmailOtpInput!) {\n  auth_sendEmailOtp(input: $input) {\n    message\n    token\n  }\n}\n\nmutation Auth_verifyEmailOtp($input: Auth_verifyEmailOtpInput!) {\n  auth_verifyEmailOtp(input: $input) {\n    message\n  }\n}\n\nmutation Auth_CreateAccount($input: Auth_CreateAccountInput!) {\n  auth_createAccount(input: $input) {\n    message\n  }\n}"): (typeof documents)["mutation Auth_login($input: Auth_LoginInput!) {\n  auth_login(input: $input) {\n    firstname\n    country\n    lastname\n    middlename\n    email\n    token\n  }\n}\n\nmutation Auth_resetPassword($input: Auth_ResetPasswordInput!) {\n  auth_resetPassword(input: $input) {\n    message\n  }\n}\n\nmutation Auth_sendEmailOtp($input: Auth_sendEmailOtpInput!) {\n  auth_sendEmailOtp(input: $input) {\n    message\n    token\n  }\n}\n\nmutation Auth_verifyEmailOtp($input: Auth_verifyEmailOtpInput!) {\n  auth_verifyEmailOtp(input: $input) {\n    message\n  }\n}\n\nmutation Auth_CreateAccount($input: Auth_CreateAccountInput!) {\n  auth_createAccount(input: $input) {\n    message\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation BankAccount_delete($input: BankAccount_DeleteInput!) {\n  bankAccount_delete(input: $input) {\n    message\n  }\n}\n\nmutation BankAccount_create($input: BankAccount_CreateInput!) {\n  bankAccount_create(input: $input) {\n    id\n    bank_name\n    account_name\n    account_no\n  }\n}\n\nquery BankAccount_getAll {\n  bankAccount_getAll {\n    id\n    account_name\n    account_no\n    bank_name\n  }\n}"): (typeof documents)["mutation BankAccount_delete($input: BankAccount_DeleteInput!) {\n  bankAccount_delete(input: $input) {\n    message\n  }\n}\n\nmutation BankAccount_create($input: BankAccount_CreateInput!) {\n  bankAccount_create(input: $input) {\n    id\n    bank_name\n    account_name\n    account_no\n  }\n}\n\nquery BankAccount_getAll {\n  bankAccount_getAll {\n    id\n    account_name\n    account_no\n    bank_name\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation WalletCrypto_create {\n  walletCrypto_create {\n    address\n    chainType\n    id\n    wallet_id\n  }\n}\n\nquery WalletCrypto_getAll {\n  walletCrypto_getAll {\n    address\n    chainType\n    id\n    wallet_id\n  }\n}"): (typeof documents)["mutation WalletCrypto_create {\n  walletCrypto_create {\n    address\n    chainType\n    id\n    wallet_id\n  }\n}\n\nquery WalletCrypto_getAll {\n  walletCrypto_getAll {\n    address\n    chainType\n    id\n    wallet_id\n  }\n}"];
