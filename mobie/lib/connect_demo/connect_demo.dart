...
import 'package:mobarter/connect_demo/select_chain_page.dart';
import 'package:mobarter/connect_demo/select_wallet_type.dart';
...
class _ConnectDemoPageState extends State<ConnectDemoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Connect Demo")),
