...
class Query$FxRate_GetAll {
  ...
  int get hashCode {
    final l$fxRate_GetAll = fxRate_GetAll;
    final l$$__typename = $__typename;
    return Object.hashAll([l$fxRate_GetAll, l$$__typename]);
  }
...
extension UtilityExtension$Query$FxRate_GetAll on Query$FxRate_GetAll {
  CopyWith$Query$FxRate_GetAll<Query$FxRate_GetAll> get copyWith =>
      CopyWith$Query$FxRate_GetAll(this, (i) => i);
}
...
class _CopyWithImpl$Query$FxRate_GetAll<TRes>
  ...
  _CopyWithImpl$Query$FxRate_GetAll(this._instance, this._then);
...
const documentNodeQueryFxRate_GetAll = DocumentNode(
  definitions: [
...
typedef OnQueryComplete$Query$FxRate_GetAll =
    FutureOr<void> Function(Map<String, dynamic>?, Query$FxRate_GetAll?);
...
extension ClientExtension$Query$FxRate_GetAll on graphql.GraphQLClient {
  ...
  ]) async => await this.query(options ?? Options$Query$FxRate_GetAll());
  ...
  void writeQuery$FxRate_GetAll({
    ...
    graphql.Request(
      operation: graphql.Operation(document: documentNodeQueryFxRate_GetAll),
    ),
    data: data.toJson(),
    broadcast: broadcast,
  );
...
graphql.ObservableQuery<Query$FxRate_GetAll> useWatchQuery$FxRate_GetAll([
  ...
  options ?? WatchOptions$Query$FxRate_GetAll(),
);
...
extension UtilityExtension$Query$FxRate_GetAll$fxRate_GetAll
  ...
  get copyWith => CopyWith$Query$FxRate_GetAll$fxRate_GetAll(this, (i) => i);
}
...
class _CopyWithImpl$Query$FxRate_GetAll$fxRate_GetAll<TRes>
  ...
  _CopyWithImpl$Query$FxRate_GetAll$fxRate_GetAll(this._instance, this._then);
